        ...
        <div class="isLogin">
          <div class="label-header">
            ...
            <el-menu :router="true" :default-active="defaultActive" class="el-menu-demo" mode="horizontal" style="display:inline-block;" :show-timeout="0" :hide-timeout="0">
              ...
              <el-menu-item index="/label/markingtool" :route="{path:'/label/markingtool'}"><i class="fa fa-pencil" style="position:relative;bottom:2px;" aria-hidden="true"></i>&nbsp;&nbsp;工作台</el-menu-item>
