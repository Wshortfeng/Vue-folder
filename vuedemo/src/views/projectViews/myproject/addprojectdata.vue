          ...
          class="upload-box"
           ...
           <div   v-loading="uploading">
            ...
            <div class="el-upload__tip" slot="tip" style="font-size:12px;color:#999;line-height:20px;">
              ...
              请先上传医学图像，文件格式： .jpg、.jpeg、.png等，再上传病历数据，文件格式：.xlsx、.xls，也可以都放在一个.zip压缩包中。<a href="http://122.152.212.188:8080/labelcloud/static/template.xlsx" style="color:#5A7CD0;">病例数据模板下载</a>
            </div>
          </el-upload>
        </el-form-item>
          <el-form-item style="margin:0;">
