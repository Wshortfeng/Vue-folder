			...
			$(".imageLabel-content").mousedown(function(e) {
					if(d = e.button, 2 != e.button) {
						if(f.hide(), b = !0, r = $(this), t = {
								...
								p = !0, s = $(e.target), c = JSON.parse(s.attr("data-json")), o = $.extend({}, c), n.startArea();
								return false;
							} else if($(e.target).hasClass("imageLable-i")) {
								v = !0, g = $(e.target), s = $(e.target).parents(".imageLabel-imgdrop"), c = JSON.parse(s.attr("data-json")), o = $.extend({}, c);
							} else {
							m = (new Date).getTime(), p = !1, s = $('<img src="' + mycontent.imageSrc + '" class="imageLabel-imgdrop" >');
							s.css({
								left: 100 * o.x + "%",
								top: 100 * o.y + "%"
							})
				...
				$(".imageLabel-img-boxs").mousemove(function(e) {
					if(b) {
						o.x = (e.clientX - t.x) / t.w, o.y = (e.clientY - t.y) / t.h;
						o.y < 0 && (o.y = 0),
							o.x < 0 && (o.x = 0),
							o.y > 1 && (o.y = 1),
							o.x > 1 && (o.x = 1),
					...
					if(b) {
						var i = {};
						i.x = o.x, i.y = o.y,
							s.attr("data-json", JSON.stringify($.extend(o, i))), !p && !v ? (n.editPop && ($(".imageLabel-input").addClass("imageLabel-active").find("input").val(""), setTimeout(function() {
			...
			$(".imageLabel-content").mousedown(function(e) {
					if(d = e.button, 2 != e.button) {
						if(f.hide(), b = !0, r = $(this), t = {
							...
							for(var a = 0; a < 4; a++) s.find(".imageLable-i-s").append('<i class="imageLable-i">');
							if(n.shade)
								for(var i = 0; i < 4; i++) s.append('<em class="imageLable-em">');
							s.addClass("imageLabel-drop-edit").appendTo(r), s.siblings().removeClass("imageLabel-drop-edit")
						}
				...
				$(".imageLabel-img-boxs").mousemove(function(e) {
					if(b) {
						...
						o.y < 0 && (o.y = 0), o.x < 0 && (o.x = 0), o.ey < 0 && (o.ey = 0), o.ex < 0 && (o.ex = 0), o.ey > 1 && (o.ey = 1), o.ex > 1 && (o.ex = 1), o.y > 1 && (o.y = 1), o.x > 1 && (o.x = 1),
							s.css({
