                ...
                <el-row class="video-box">
                  <el-col :span="24/Math.sqrt(showNum)" v-for="(item, index) in videoList" :key="index">
                    <el-card :body-style="{ padding: '0px' }">
                      <video-player class="video-player vjs-custom-skin" ref="videoPlayer" :playsinline="true" :options="item.playerOptions" @play="onPlayerPlay($event)" @pause="onPlayerPause($event)"></video-player>
                    </el-card>
                  </el-col>
          ...
          <el-row>
            ...
            <el-col :span="24" class="right-bottom2">
              ...
              <div class="grid-content alarmimagelist">
                <div class="img-box">
                  <img src="../assets/img/arrow-left.png" class="left" @click="scrollTo(-1)">
                  <img src="../assets/img/arrow-right.png" class="right" @click="scrollTo(1)">
