        ...
        <transition name="fade" mode="out-in">
          <div v-if="type==1" v-loading="isloading1">
            <div class="search-box">
              <div class="search-item">
                <span>分屏数目：</span>
                <el-select v-model="number" filterable placeholder="请选择" class="min_select1">
              ...
              <div class="videoList">
                ...
                <div class="centerbox">
                  <el-button type="primary" @click="getAlarmList">确 定</el-button>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    getAlarmList() {
      //确定分屏
      this.$api.alarmsetup.getAlarmList(this.number).then(res => {
        if (res.code == 200) {
