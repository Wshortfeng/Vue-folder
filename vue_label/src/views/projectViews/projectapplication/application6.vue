    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="160px" class="demo-ruleForm" v-loading="isloading">
      <ul class="application-con-ul">
        <li>
          ...
          <el-form-item label="会诊单价（元/个）：" prop="consultationPrice" v-if="acceptanceType==2&&isConsultation==1&&isSecondReview==1">
      ...
      this.$api.project
        ...
        .then(res => {
          if (res.code == 200) {
            ...
            this.isSecondReview = res.data.bzProject.isSecondReview.toString();
