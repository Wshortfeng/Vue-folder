...
export default {
    ...
    state: {
        ...
        notreadmessage: 0,
        REMEMBERLOGOINSTATUS: false,
        useraccountBalance: 0,
        permission: utils.getStorage('PERMISSION'),
    },
    ...
    mutations: {
        ...
        setRememberloginstatus: (state, REMEMBERLOGOINSTATUS) => {
            state.REMEMBERLOGOINSTATUS = REMEMBERLOGOINSTATUS
            utils.setStorage("REMEMBERLOGOINSTATUS", REMEMBERLOGOINSTATUS);
            utils.setSession("REMEMBERLOGOINSTATUS", REMEMBERLOGOINSTATUS);
        },
        ...
        setPermission: (state, permission) => {
            ...
            utils.setStorage("PERMISSION", permission);
        }
    },
    actions: {
        // 用户名登录
